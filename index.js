...
const ucebolunenlerintoplami = ucetambolunenler.reduce(sum);
...
const besyuzdenkucuksayilar = sayilar.filter(besyuzkucuk = element => element <500);
...
for (let sayi in tekrarEdenSayilar) {
  if (tekrarEdenSayilar[sayi] > 1) {
    ...
    let mesaj = `${sayi} sayısı ${tekrarSayisi} kere tekrar edilmiştir`;
